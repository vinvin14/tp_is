...
@section('main')
    ...
    <div class="card shadow-sm w-50 mt-2">
        ...
        <div class="card-body">
            <form action="{{ route('product.quantity.store', $product->id) }}" method="post">
                @csrf
                <div class="form-group">
                    <label for="received-date">Received Date</label>
                    <input type="date" id="received-date" name="received_date" class="form-control">
                </div>
                <div class="form-group">
                    <label for="expiration">Expiration Date</label>
                    <input type="date" id="expiration" name="expiration_date" class="form-control">
                </div>
                <div class="form-group">
