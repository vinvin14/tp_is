    ...
    <div class="col-6">
        <div class="card shadow-sm mt-2">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('category.upsave', $category->id) }}" method="post" role="form">
                    @csrf
                    <div class="row text-left">
                        ...
                        <div class="col-9">
                            <input type="text" name="category_name" class="form-control" value="{{ $category->category_name }}" placeholder="Unit Name here" required>
                        </div>
                    </div>
                    ...
                    <button type="submit" class="btn btn-success mt-3 float-right"><i class="fas fa-fw fa-check"></i>Apply Changes</button>
                </form>
            </div>
        </div>
    </div>
