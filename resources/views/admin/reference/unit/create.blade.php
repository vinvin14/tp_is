            ...
            <div class="card-body">
                ...
                <form action="{{ route('unit.store') }}" method="post" role="form">
                    ...
                    <div class="row text-left">
                        ...
                        <div class="col-9">
                            <input type="text" name="unit_name" class="form-control" value="{{ old('unit_name') }}" placeholder="Unit Name here" required>
                        </div>
                    </div>
                    <div class="row mt-3 text-left">
                        ...
                        <div class="col-9">
                            <input type="text" name="second_level_unit" class="form-control" value="{{ old('second_level_unit') }}" placeholder="Second Level Unit here">
                        </div>
                    </div>
