...
@section('main')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-fw fa-handshake"></i> Walk-in Transactions Table</h6>
        </div>
        <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="text-center">
                                    <a href="{{route('walkinTransaction.show', $transaction->id)}}" class="pr-2"><i class="fas fa-fw fa-eye" title="View"></i></a>
                                    <a href="{{route('walkinTransaction.destroy', $transaction->id)}}" class="pl-2" onclick="return confirm('Are you sure you want to delete this transaction?')"><i class="fas fa-fw fa-trash text-danger" title="Delete"></i></a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
