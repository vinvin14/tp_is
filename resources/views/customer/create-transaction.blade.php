...
@endsection
@section('main')
    <a href="{{route('customer.show', $customer->id)}}" class="font-weight-bold"><i
            class="fas fa-fw fa-arrow-alt-circle-left"></i> Back to Customer Record</a>
                ...
                <form action="{{ route('transaction.store') }}" method="post">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input type="text" name="customer_name" value="{{$customer->lastname.', '.$customer->firstname.' '.$customer->middlename}}" id="customer_select" class="form-control" readonly required>
                        </div>
                        <div class="col-6">
